...
### `langchain-azure-container-apps`

| Namespace | DRI | Secondary DRI |
|-----------|-----|---------------|
| `langchain_azure_container_apps.dynamic_sessions` | @darieldatoon | @kyleknap |
| `langchain_azure_container_apps.sandboxes` | @darieldatoon | @kyleknap |
