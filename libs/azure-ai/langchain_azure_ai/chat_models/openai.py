...
class AzureAIOpenAIChatCompletionsModel(AzureChatOpenAI):
    """Azure AI chat completions model using the OpenAI-compatible API.
    ...
    **Project-endpoint pattern (recommended for Azure AI Foundry):**
    ...
    model = AzureAIOpenAIChatCompletionsModel(
        project_endpoint=(
    ...
    **Direct endpoint + API-key pattern:**
    ...
    ```python
    from langchain_azure_ai.chat_models import AzureAIOpenAIChatCompletionsModel
