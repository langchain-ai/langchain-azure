...
class AzureLogicAppTool(BaseTool):
    ...
    description: str = (
        "Invokes Azure Logic Apps workflows to trigger automated business processes and integrations. "
        "Use this to execute pre-configured workflows such as sending emails, processing data, calling APIs, "
        "or integrating with other Azure and third-party services. Input is JSON payload for the workflow trigger. "
        "Ideal for automation tasks, notifications, data synchronization, and orchestrating multi-step processes."
    )
