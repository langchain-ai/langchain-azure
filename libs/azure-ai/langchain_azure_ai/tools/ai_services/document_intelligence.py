...
class AzureAIDocumentIntelligenceTool(BaseTool, AIServicesService):
    ...
    description: str = (
        "Extracts structured content from documents using Azure AI Document Intelligence. "
        "Analyzes PDFs, images, and Office files to extract text, tables, key-value pairs, "
        "and form fields with high-accuracy OCR. Ideal for parsing invoices, receipts, forms, "
        "contracts, and documents requiring structured data extraction. Accepts file paths or URLs. "
        "Returns text content, tables with preserved formatting, and document metadata."
    )
