...
class AzureAITextAnalyticsHealthTool(BaseTool, AIServicesService):
    ...
    description: str = (
        "Extracts medical entities from healthcare text using Azure AI Text Analytics for Health. "
        "Identifies diagnoses, medications, symptoms, treatments, dosages, body structures, and their relationships. "
        "Use for clinical notes, medical records, patient summaries, or research papers. "
        "Input: medical text. Output: identified healthcare entities with categories and confidence scores."
    )
