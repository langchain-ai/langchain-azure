"""Integration tests for Azure AI Agents V2."""
...
class TestAgentServiceFactoryV2Integration:
    ...
    def test_basic_agent_creation_and_interaction(self) -> None:
        ...
        agent = self.service.create_prompt_agent(
            name="test-integration-agent-v2",
            model=self.model,
    ...
    def test_agent_with_temperature(self) -> None:
        ...
        agent = self.service.create_prompt_agent(
            model=self.model,
            name="test-temperature-agent-v2",
