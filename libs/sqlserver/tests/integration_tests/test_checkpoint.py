...
_CONNECTION_STRING = os.environ.get("TEST_AZURESQLSERVER_TRUSTED_CONNECTION")
_PYODBC_CONNECTION_STRING = os.environ.get("TEST_PYODBC_CONNECTION_STRING")
...
def saver() -> Generator[SQLServerSaver, None, None]:
    ...
    if not _CONNECTION_STRING:
        pytest.skip("TEST_AZURESQLSERVER_TRUSTED_CONNECTION not set")
