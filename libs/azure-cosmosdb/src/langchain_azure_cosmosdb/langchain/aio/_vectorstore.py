...
import numpy as np
from langchain_azure_cosmosdb.langchain._utils import maximal_marginal_relevance
...
class AsyncAzureCosmosDBNoSqlVectorSearch(VectorStore):
    ...
    async def adelete_document_by_id(
        ...
        if document_id is None:
            raise ValueError("No document ids provided to delete.")
        await self._container.delete_item(document_id, partition_key=document_id)
