"""Synchronous VectorStore integration for Azure Database for PostgreSQL using LangChain."""
...
class AzurePGVectorStore(BaseModel, VectorStore):
    ...
    def from_documents(
        ...
        **kwargs: Any,
        ...
        vs.add_documents(documents, **kwargs)
        return vs
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        vs.add_texts(texts, metadatas, ids=ids, **kwargs)
        return vs
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        ...
        match self.embedding_index.op_class:
            case (
                ...
                return AzurePGVectorStore._cosine_relevance_score_fn
            case (
                VectorOpClass.vector_ip_ops
                | VectorOpClass.halfvec_ip_ops
                | VectorOpClass.sparsevec_ip_ops
            ):
                return AzurePGVectorStore._max_inner_product_relevance_score_fn
            case (
                VectorOpClass.vector_l2_ops
                | VectorOpClass.halfvec_l2_ops
                | VectorOpClass.sparsevec_l2_ops
            ):
                return AzurePGVectorStore._euclidean_relevance_score_fn
            case (
    ...
    # Async methods below are not implemented in this class.
