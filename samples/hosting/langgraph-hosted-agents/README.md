...
| 99 | [Resilient](responses/99_resilient/) | Trip-planning agent combining background Responses, replayable output, exact checkpoint recovery, active-turn steering, durable HITL, retrieval, and cancellation. |
...
| 99 | [Resilient](invocations/99_resilient/) | Trip-planning agent combining resilient background invocations, exact checkpoint recovery, durable HITL, foreground streaming, retrieval, and cancellation. |
